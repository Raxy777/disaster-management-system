...
import { AlertTriangle, Eye, EyeOff, Info, KeyRound, Shield, User } from "lucide-react"
        ...
        <CardContent className="pb-4">
          <Tabs defaultValue="user" className="w-full" onValueChange={(value) => setUserType(value as UserRole)}>
            ...
            <form onSubmit={handleLogin} className="space-y-4 pt-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" className="text-xs text-[#29ABE2] hover:underline">
                    Forgot password?
                  </Link>
                </div>
                <div className="relative">
            ...
            <div className="mt-4 text-center text-sm">
              ...
              <Link href="/register" className="font-medium text-[#29ABE2] hover:underline">
                Register
              </Link>
            </div>
